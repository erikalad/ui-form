...
const Pregunta14 = () => {
  ...
  return (
    ...
    <div className='flip-in-hor-top '>
      ...
      <div className='carta'>
        <div className='tracking-in-expand'>¿Qué imagen tiene de Bertha Xóchitl Gálvez Ruiz?</div>
       ...
       <Link to='/13'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/15'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
