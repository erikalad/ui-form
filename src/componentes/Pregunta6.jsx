  ...
  return (
    ...
    <div className='flip-in-ver-right'>
      ...
      <div className='carta-grande'>
        <div className='tracking-in-expand titulo'>Podría indicarnos en ¿qué municipio de Ciudad de México reside actualmente?</div>
        <div className='contenedor-pregunta4'>

    <Radio.Group onChange={onChange} value={value}>
      <Space direction="vertical">
        <Radio value={1}>Álvaro Obregón</Radio>
         <hr color='#eaeaea'/>
        <Radio value={2}>Azcapotzalco</Radio>
         <hr color='#eaeaea'/>
        <Radio value={3}>Benito Juárez</Radio>
         <hr color='#eaeaea'/>
        <Radio value={4}>Coyoacán</Radio>
         <hr color='#eaeaea'/>
         <Radio value={5}>Cuauhtémoc</Radio>
         <hr color='#eaeaea'/>
         <Radio value={6}>Gustavo A. Madero</Radio>
         <hr color='#eaeaea'/>
         <Radio value={7}>Iztapalapa</Radio>
         <hr color='#eaeaea'/>
         <Radio value={8}>Tlalpan</Radio>
         <hr color='#eaeaea'/>
         <Radio value={9}>Venustiano Carranza</Radio>
         <hr color='#eaeaea'/>
         <Radio value={10}>Xochimilco</Radio>
         <hr color='#eaeaea'/>
         <Radio value={11}>Otro</Radio>
         <hr color='#eaeaea'/>
      </Space>
    </Radio.Group>
