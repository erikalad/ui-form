...
const Pregunta13 = () => {
  ...
  return (
    ...
    <div className='flip-in-hor-top '>
      ...
      <div className='carta'>
        <div className='tracking-in-expand'>¿Qué imagen tiene de Claudia Sheinbaum Pardo?</div>
       ...
       <Link to='/12'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/14'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
