  ...
  return (
    ...
    <div className='flip-in-hor-top '>
      ...
      <div className='carta-grande'>
        <div className='tracking-in-expand titulo'>En relación al gobierno nacional, ¿Usted se considera oficialista u opositor?</div>
...
No sabe
       ...
       <Link to='/17'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/19'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
