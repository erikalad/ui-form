...
const Pregunta26 = () => {
  ...
  return (
    ...
    <div className='rotate-in-2-tr-ccw'>
      ...
      <div className='carta'>
        <div className='tracking-in-expand'>Pensando en la situación actual del país, ¿usted diría que hay estabilidad o inestabilidad?</div>
   ...
   Siento que hay inestabilidad
       ...
       <Link to='/25'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/27'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
