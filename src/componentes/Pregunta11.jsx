  ...
  return (
    ...
    <div className='flip-in-hor-top '>
      ...
      <div className='carta-grande'>
        <div className='tracking-in-expand titulo'>¿Usted podría votar a un candidato de la coalición Frente Amplio por México como presidente?</div>
...
No sabe
       ...
       <Link to='/10'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/12'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
