...
const Pregunta27 = () => {
  ...
  return (
    ...
    <div className='rotate-in-2-tr-ccw'>
      ...
      <div className='carta'>
        <div className='tracking-in-expand'>¿Siente que en el país prevalece el orden o el desorden?</div>
 ...
 Siento que hay desorden
       ...
       <Link to='/26'> <Button type="primary" shape="circle" icon={<ArrowLeftOutlined />} className='boton-next'/></Link>
       <Link to='/28'> <Button type="primary" shape="circle" icon={<ArrowRightOutlined />} className='boton-next' disabled={botonDeshabilitado}/></Link>
        </div>
      </div>
      </div>
    </div>
